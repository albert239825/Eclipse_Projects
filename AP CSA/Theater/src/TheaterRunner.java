...
public class TheaterRunner {
	...
	public static void main(String[] args)
	{
		...
		ArrayList<Integer> isles = new ArrayList<>();
		//isles.add(2);
		//isles.add(4);
		Theater theater1= new Theater(5,4,customerList1, true, isles);
		...
		System.out.println();
		theater1.rearrange();
		System.out.println("" + "fixed theater: \n" + theater1);
		...
		Theater theater2= new Theater(7,6,customerList2,true, new ArrayList<Integer>());
